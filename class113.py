...
from_dir = "D:\Downloads"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/Lenovo/Desktop/New Folder" #Create "Document_Files" folder in your Desktop and update the path accordingly.
